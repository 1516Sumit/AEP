...
import building from "../img/image copy 2.jpg";
  ...
  return (
    ...
    >
      <div id="second-box" className="flex justify-center items-center md:justify-auto md:items-auto md:flex-row flex-col h-auto md:h-[70vh] w-[95vw] md:w-[80vw]" data-aos="fade-up"
        ...
        data-aos-anchor-placement="top-center">
          <h6 style={{ color: "#191939", fontWeight:"bolder", fontFamily:"Montserrat" }}>our story</h6>
          <h2 style={{ color: "#191939", fontWeight:"bolder", fontFamily:"Montserrat"  }}>AEP Technology</h2>
          <hr style={{ width: "10vw", height: "5px", margin: "0", color: "#191939", fontWeight:"bolder" }}></hr>
          <p className="buildText text-base">
