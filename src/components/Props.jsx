  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="home1"
          className="h-[40rem] md:h-[30rem] lg:h-auto flex flex-col items-center md:items-auto justify-center md:justify-between overflow-hidden"
        >
          <Tilt tiltMaxAngleX={8}
            tiltMaxAngleY={8}>
            <h1
              id="hi"
              className="w-full text-center !text-5xl md:!text-7xl lg:text-8xl md:!mt-56 lg:mt-0 md:!mb-4"
            >
              {props.heading}
            </h1>
          </Tilt>
